...
import ch.maak.ch.wl.communitylevels.client.AbstractRankColumn;
import ch.maak.wl.communitylevels.communitylevels.client.ClientSession;
import ch.maak.wl.communitylevels.communitylevels.client.level.AbstractShowLevelMenu;
import ch.maak.wl.communitylevels.communitylevels.client.records.StatisticsForm.MainBox.RecordsBox.LongestTimespanField;
import ch.maak.wl.communitylevels.communitylevels.client.records.StatisticsForm.MainBox.RecordsBox.MostRecordsOnDateField;
import ch.maak.wl.communitylevels.communitylevels.client.records.StatisticsForm.MainBox.StatisticsBox.StatisticsTileField;
...
import ch.maak.wl.communitylevels.communitylevels.shared.records.StatisticsFormData;
...
public class StatisticsForm extends AbstractForm {
	...
	public MostRecordsOnDateField getLongestRecordField() {
		return getFieldByClass(MostRecordsOnDateField.class);
	}

	public LongestTimespanField getLongestTimespanField() {
		return getFieldByClass(LongestTimespanField.class);
	}

	public StatisticsTileField getStatisticsTileField() {
		return getFieldByClass(StatisticsTileField.class);
	}
