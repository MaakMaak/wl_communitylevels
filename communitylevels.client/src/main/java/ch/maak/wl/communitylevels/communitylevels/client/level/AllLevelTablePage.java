...
public class AllLevelTablePage extends AbstractPageWithTable<Table> {
	protected LevelTablePageParam m_param;

	public AllLevelTablePage(LevelTablePageParam param) {
		super();
		m_param = param;
	}
	...
	public AllLevelTablePage() {
		super();
		m_param = new LevelTablePageParam();
	}
	...
	public void initPage() {
		super.initPage();
		if (m_param.getRecordHolderName() != null) {
			Cell cell = getCellForUpdate();
			cell.setText(String.format("Records %s", m_param.getRecordHolderName()));
		}
		if (m_param.getCreatorName() != null) {
			Cell cell = getCellForUpdate();
			cell.setText(String.format("Created by %s", m_param.getCreatorName()));
		}
	}
	...
	protected AllLevelTablePageData getTablePageData(LevelSearchFormData formData) {
		return BEANS.get(ILevelPageService.class).getLevelTableData(formData, m_param);
	}
